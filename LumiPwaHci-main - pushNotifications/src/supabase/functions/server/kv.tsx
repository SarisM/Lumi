// Wrapper for KV store with correct table name
// The kv_store.tsx file uses the wrong table name, so we create this wrapper
import { createClient } from "jsr:@supabase/supabase-js@2.49.8";

const TABLE_NAME = "kv_store_7e221a31";
